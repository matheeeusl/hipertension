...
export const ReadingTableRow = ({
  ...
  return (
    <>
      <TableRow className="cursor-pointer" onClick={openDialog}>
        ...
        <TableCell className="text-sm">
          {formatDate(reading.recorded_at, dateFormat, dateFnsLocale)}
        </TableCell>
              ...
              <DialogHeader>
                ...
                <DialogDescription asChild>
                  <span className="text-sm text-muted-foreground">
                    {formatDate(reading.recorded_at, "MMM dd, yyyy HH:mm", dateFnsLocale)}
                  </span>
                </DialogDescription>
              </DialogHeader>
            ...
            <>
              ...
              <div className="space-y-3 text-sm">
                <div className="flex justify-between border-b pb-2">
                  ...
                  <span>{formatDate(reading.recorded_at, "MMM dd, yyyy HH:mm", dateFnsLocale)}</span>
                </div>
                <div className="flex justify-between border-b pb-2">
